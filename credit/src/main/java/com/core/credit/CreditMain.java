...
/**
 * The main entry point for running the credit applications.
 * In production, {@link Main} should be used, but this makes running in the IDE easier.
 *
